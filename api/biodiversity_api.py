...
def import_organisms(class_name=None, order=None, source_system="NSR", size=1000):
    ...
    if class_name:
        query_params["defaultClassification.className"] = class_name
    if order:
        query_params["defaultClassification.order"] = order
